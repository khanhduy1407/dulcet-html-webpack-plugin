...
var LoaderTargetPlugin = require('@dulcetjs/webpack/lib/LoaderTargetPlugin');
...
/**
 * Returns the child compiler name e.g. 'dulcet-html-webpack-plugin for "index.html"'
 */
function getCompilerName (context, filename) {
  ...
  return 'dulcet-html-webpack-plugin for "' + (absolutePath.length < relativePath.length ? absolutePath : relativePath) + '"';
}
